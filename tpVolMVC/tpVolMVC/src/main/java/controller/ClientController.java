...
public class ClientController {
	...
	public ModelAndView saveClientPhysique(@ModelAttribute("client") ClientMoral clientMoral, BindingResult br) {
		return save(clientMoral, br);
	}

	@RequestMapping("/saveclientel")
	public ModelAndView saveClientPhysique(@ModelAttribute("client") ClientEl clientEl, BindingResult br) {
